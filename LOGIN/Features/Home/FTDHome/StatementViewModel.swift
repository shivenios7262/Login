...
enum TransactionType: String, CaseIterable, Identifiable {
    ...
    case cabBooking        = "Cab Booking"
    case hotelBooking      = "Hotel Booking"
    case insuranceBooking  = "Insurance Booking"
    case visaBooking       = "VISA Booking"
    case esimBooking       = "eSIM Booking"
    case flightRefund      = "Flight Refund"
    case busRefund         = "Bus Refund"
    case cabRefund         = "Cab Refund"
    case hotelRefund       = "Hotel Refund"
    case insuranceRefund   = "Insurance Refund"
    case visaRefund        = "VISA Refund"
    case esimRefund        = "eSIM Refund"
