...
struct TermsConditionView: View {
    ...
    @State var viewModel: TermsConditionViewModel
...
private struct TermsHTMLWebView: UIViewRepresentable {
    ...
    private var styledHTML: String {
        ...
        <style>
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          em, i { color: #666; font-style: italic; }
        </style>
        </head>
        <body>
        \(html)
